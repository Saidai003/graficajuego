    ...
    while (1) {
        ...
        if(input == 'e' && cursorX == 3 && cursorY == 0){
            try{ //existe la carpeta en ese indice=posicion
                ...
                printf("Select the folder's name and press Enter to create it\n");
                printf("Folder name: ");
                ...
                D newfolder(foldername,"user", true, true);

                current.dires.push_back(newfolder);
        ...
        /*if(input == 'e' && cursorX > 4){
            try{ //existe la carpeta en ese indice=posicion
                auto changedire = current.dires.at(cursorX);
                showdire = changedire;
        ...
        /*for(auto it = current.dires.rbegin(); it != current.dires.rend(); ++it){
